...
class LCSNew {
 public:
  ...
  LCSNew(const std::vector<Eigen::MatrixXd>& A,
  ...
  LCSNew(const Eigen::MatrixXd& A, const Eigen::MatrixXd& B,
      const Eigen::MatrixXd& D, const Eigen::VectorXd& d,
      const Eigen::MatrixXd& E, const Eigen::MatrixXd& F,
      const Eigen::MatrixXd& H, const Eigen::VectorXd& c, const int& N);

  /// Simulate the system for one-step, also return the calculated force
  /// @param x_init Initial x value
  /// @param input Input value
  std::pair <Eigen::VectorXd,Eigen::VectorXd> Simulate(Eigen::VectorXd& x_init, Eigen::VectorXd& input);
