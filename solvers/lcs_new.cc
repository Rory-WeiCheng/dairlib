...
LCSNew::LCSNew(const vector<MatrixXd>& A, const vector<MatrixXd>& B,
...
//    std::cout << "D times LCS force estimate" << std::endl;
  ...
  std::pair <VectorXd, VectorXd> state_force (x_final, force);
  return state_force;
}
