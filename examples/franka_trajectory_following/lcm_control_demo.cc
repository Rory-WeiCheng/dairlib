...
//  q(2) = param.finger_radius + 2*param.ball_radius + param.table_offset;
  q(2) = param.finger_radius + 2*param.ball_model_radius + param.table_offset;
  ...
  Ginit.block(nq+nv+4,nq+nv+4,4,4) = param.G_ground * MatrixXd::Identity(4, 4);
...
//      q(q_map["base_z"]) = param.ball_radius + param.table_offset;
      q(q_map["base_z"]) = param.ball_model_radius + param.table_offset;
